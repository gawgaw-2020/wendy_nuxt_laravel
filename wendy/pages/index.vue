            ...
            <li class="mini-store-card" v-for="(article, index) in osoLunchArticles" :key="index">
              <nuxt-link :to="`/article/${article.store_id}`">
                ...
                <div class="mini-store-card__content">
                  ...
                  <p class="mini-store-card__discount-price">ずらし飯価格 <span>{{ Math.floor(article.coupons[0].normal_price * ((100 - article.coupons[0].discount_rate) / 100)).toLocaleString() }}<span class="yen">円</span></span></p>
                </div>
              </nuxt-link>
            </li>
          </ul>
            ...
            <li class="mini-store-card" v-for="(article, index) in hayaDinnerArticles" :key="index">
              <nuxt-link :to="`/article/${article.store_id}`">
                ...
                <div class="mini-store-card__content">
                  ...
                  <p class="mini-store-card__discount-price">ずらし飯価格 <span>{{ Math.floor(article.coupons[1].normal_price * ((100 - article.coupons[1].discount_rate) / 100)).toLocaleString() }}<span class="yen">円</span></span></p>
                </div>
              </nuxt-link>
            </li>
          </ul>
            ...
            <li class="mini-store-card" v-for="(article, index) in osoDinnerArticles" :key="index">
              <nuxt-link :to="`/article/${article.store_id}`">
                ...
                <div class="mini-store-card__content">
                  ...
                  <p class="mini-store-card__discount-price">ずらし飯価格 <span>{{ Math.floor(article.coupons[2].normal_price * ((100 - article.coupons[2].discount_rate) / 100)).toLocaleString() }}<span class="yen">円</span></span></p>
                </div>
              </nuxt-link>
            </li>
          </ul>
